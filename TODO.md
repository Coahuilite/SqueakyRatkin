...
- [ ] 0.3.0 Steam 发布收尾：人工上传 `dist/steam/SqueakyRatkin`（**非 SteamCMD**）→ 玩家视角只读页面核验（同一 item、描述版本、Updated、change notes 数）→ Release Claim Pack（`docs/release_review/release-0.3.0-review-zh.md`）→ MEMORY/TODO 收尾
