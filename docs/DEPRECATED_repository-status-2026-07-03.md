# DEPRECATED — Repository Status Report — 2026-07-03

> **Historical snapshot — do not use as current guidance.** Current durable state and active work are in [`../MEMORY.md`](../MEMORY.md) and [`../TODO.md`](../TODO.md); current product contracts are indexed by [`../AGENTS.md`](../AGENTS.md). The original snapshot follows for archaeology only.
