...
- 实现前将受影响结论提升进 `project-architecture-contract.md`（0.3.1：域键与 selection 语义、17 动作、选择链末端、fallback 工件写通道）与设置合同；`voice-pack-author-guide-zh.md` 在 US 拆分前不新增外部动作注册 schema 章节。
