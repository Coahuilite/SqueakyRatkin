# DEPRECATED — 文案人工审核归档 / Text Review Archive

> **历史审核，请勿作为现行指南。** 当前玩家与作者文档以仓库 README、[`voice-pack-author-guide-zh.md`](./voice-pack-author-guide-zh.md) 及现行合同为准；下文仅供考古。

> **历史快照 / superseded:** This 2026-07-05 review is preserved as a historical text snapshot, not current guidance. Its `1.6/Sounds/Squeak` and `AUDIO_GUIDE` installation instructions were removed by the 0.2.0 breaking change; do not follow them. Current VoicePack guidance is `docs/voice-pack-author-guide-zh.md` and `Extras/SqueakyRatkinExampleVoices/README.md`.
...
- 外部只读检查结论：`{STEAM_WORKSHOP}/294100/2142743468` 带 DLL 与大量 `DebugAction_*` Keyed；`{STEAM_WORKSHOP}/294100/2898638732` 为鼠族普通 Def/Keyed 汉化，未见 DebugAction 支持。
...
动作类别当前固定为 15 个内置 Core action（第三方/DLC 自由扩展尚未实现）:
