...
The 41 OGG Vorbis clips are 22050 Hz mono and use the 15 fixed actions: Attack 3, Call 4, Death 2,
Draft 3, Eat 2, Equip 2, Joy 3, MentalBreak 1, Move 3, Select 3, Sleep 3, Social 3, Undraft 3,
Work 3, and Wounded 3. They are the maintained Template source mirrored into the main mod's
built-in Example during staging. These Example clips are public-domain material outside the
