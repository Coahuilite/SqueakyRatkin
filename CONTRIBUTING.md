...
Maintain its fixed 15-action/41-OGG contract there only: Attack 3, Call 4, Death 2, Draft 3, Eat 2, Equip 2, Joy 3, MentalBreak 1, Move 3, Select 3, Sleep 3, Social 3, Undraft 3, Work 3, and Wounded 3. `scripts/stage-package.ps1` generates and verifies the built-in mirror. Do not submit a second main-mod audio source.
