...
2. Keep the No-DLC Core baseline, fixed 17-action ABI (with silent-by-default `Crying`/`Giggling`), XML-driven behavior, and VoicePack boundaries intact.
