...
- **ModSettings QoL**(2026-07-04):设置页顶部按短标题+GapLine 分隔“Audio source and timing / Distance attenuation / Mood modulation workbench”;距离衰减区有原生 Widgets 动态图表,显示满音量距离前平台、到静音距离的线性衰减、静音距离后归零,随滑块/输入框立即更新。
